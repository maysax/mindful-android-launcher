...
public class Launcher3App extends CoreApplication {
    ...
    private static final String TRACE_TAG = LogConfig.TRACE_TAG + "Launcher3App";
    private static final String TAG = "SiempoActivityLifeCycle";
    private static Launcher3App ourInstance;
    ...
    @VisibleForTesting
    public static void setForTesting(Launcher3App application) {
        ourInstance = application;
    }
