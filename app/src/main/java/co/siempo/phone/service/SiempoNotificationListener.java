...
public class SiempoNotificationListener extends NotificationListenerService {
    ...
    public void onListenerDisconnected() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            try {
                ...
                requestRebind(new ComponentName(this, SiempoNotificationListener.class));
    ...
    public void onNotificationPosted(StatusBarNotification notification) {
        ...
        int tempoType = PrefSiempo.getInstance(this).read(PrefSiempo.TEMPO_TYPE, 0);
        if (tempoType == 1 || tempoType == 2) {
            ...
            if (PackageUtil.isSiempoLauncher(this)) {
                ...
                String strEnableApps = PrefSiempo.getInstance(this).read(PrefSiempo.HELPFUL_ROBOTS, "");
                ...
                blockedAppList = PrefSiempo.getInstance(this).read(PrefSiempo.BLOCKED_APPLIST,
                        new HashSet<String>());
...
//            if (PrefSiempo.getInstance(this).read(PrefSiempo.CALL_RUNNING, false)) {
