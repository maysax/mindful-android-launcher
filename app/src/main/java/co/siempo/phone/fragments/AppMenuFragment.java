...
import co.siempo.phone.databinding.FragmentAppMenuBinding;
...
// TODO: 14.06.2020 replace with preferenceFragment
public class AppMenuFragment extends CoreFragment implements View.OnClickListener {
    ...
    protected ViewBinding onCreateViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final FragmentAppMenuBinding binding = FragmentAppMenuBinding.inflate(inflater, container, false);
        ...
        if (deterTime == -1) {
            binding.switchOveruseFlagged.setChecked(false);
        ...
        binding.txtReduceOveruseFlaggedDes.setText(Html.fromHtml(txtOverUseFlag));
        return binding;
    }

    private void initView(@NonNull FragmentAppMenuBinding binding) {
        binding.toolbar.setNavigationIcon(R.drawable.ic_arrow_back_blue_24dp);
        binding.toolbar.setTitle(R.string.app_menus);
        ...
        binding.switchHideIcon.setChecked(CoreApplication.getInstance().isHideIconBranding());

        binding.switchJunkFoodmize.setChecked(CoreApplication.getInstance().isRandomize());

        binding.switchOveruseFlagged.setChecked(index != -1);

        binding.relJunkFoodmize.setOnClickListener(this);
        binding.relHideIconBranding.setOnClickListener(this);
        binding.relChooseFlagApp.setOnClickListener(this);
        binding.relReduceOveruseScreen.setOnClickListener(this);
        binding.relReduceOveruseFlagged.setOnClickListener(this);
        if (isFromFlag) {
    ...
    @Override
    public void onClick(View v) {
        final FragmentAppMenuBinding binding = requireViewBinding();
...
//                }
    ...
    private void showDialog() {
        ...
        AlertDialog dialog = new AlertDialog.Builder(context)
                ...
                .setCancelable(true)
                .setSingleChoiceItems(deter_after_list, index, new DialogInterface.OnClickListener() {
                    @Override
