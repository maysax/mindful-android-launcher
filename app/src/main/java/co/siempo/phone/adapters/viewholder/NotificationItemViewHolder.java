...
public class NotificationItemViewHolder extends RecyclerView.ViewHolder {
    final TextView txt_app_name;
    final Switch switch_appNotification;
    final ImageView imv_appicon;

    public NotificationItemViewHolder(View itemView) {
        super(itemView);
        txt_app_name = itemView.findViewById(R.id.txt_app_name);
        switch_appNotification = itemView.findViewById(R.id.switch_appNotification);
