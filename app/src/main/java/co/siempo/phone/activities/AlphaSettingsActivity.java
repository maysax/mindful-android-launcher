...
public class AlphaSettingsActivity extends CoreActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_siempo_alpha_settings);
        initView();
        onClickEvents();
    }
    ...
    public void initView() {
        ...
        icon_UserId = findViewById(R.id.icon_UserId);
...
//            Crashlytics.logException(e);
    ...
    public void onClickEvents() {
        ...
        ln_permissions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AlphaSettingsActivity.this, SiempoPermissionActivity.class);
