...
public class EndlessJabberInterface {
     ...
     * @param concreteImplementation The concrete implementation to call on events
     * @param sendSMS                If true, your app will be responsible for sending SMS messages
     *                               as well as presisting them to the SMS repository
     * @param sendMMS                If true, your app will be responsible for sending & persisting
