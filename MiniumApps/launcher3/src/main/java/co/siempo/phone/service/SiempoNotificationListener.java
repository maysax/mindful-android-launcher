        ...
        if (statusBarNotification.getNotification().category == null
            ...
            try {
                ...
                if (notificationSms == null) {
                    ...
                    PackageUtil.recreateNotification(notificationSms, context, droidPrefs.tempoType().get(), droidPrefs.tempoSoundProfile().get(), launcherPrefs.isHidenotificationOnLockScreen().get());
