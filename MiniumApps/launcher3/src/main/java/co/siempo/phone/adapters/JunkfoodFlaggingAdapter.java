            ...
            if (resolveInfo.isShowHeader && resolveInfo.isShowTitle) {
                ...
                if (resolveInfo.isFlagApp) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        holder.txtNoAppsMessage.setText(searchReference.equalsIgnoreCase("") ? context.getString(R.string.tap_apps_below_to_move_them_into_this_section) : "No apps match that input text");
                    }
                } else {
