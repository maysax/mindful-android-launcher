...
public class OldMenuFragment extends CoreFragment {
    ...
    private void loadData() {
        ...
        items.add(new MainListItem(10, getString(R.string.title_tempo), "fa-bell"));
...
//        items.add(new MainListItem(9, getString(R.string.title_theme), "fa-tint"));
    ...
    public void listItemClicked(int position) {
        ...
        switch (id) {
            ...
            case 2: new ActivityHelper(getActivity()).openCallApp(); break;
            case 3: new ActivityHelper(getActivity()).openContactsApp(); break;
            case 4: PauseActivity_.intent(getActivity()).start(); break;
            ...
            case 10: TempoActivity_.intent(getActivity()).start(); break;
            case 11: new ActivityHelper(getActivity()).openGMape(Constants.GOOGLE_MAP_PACKAGE); break;
            case 12: new ActivityHelper(getActivity()).handleDefaultLauncher((CoreActivity) getActivity()); break;
            case 13: MMTimePickerActivity_.intent(getActivity()).start(); break;
            case 14: MindfulMorningActivity_.intent(getActivity()).start(); break;
            case 15: break; // Version text, no action should be taken
            case 16: new ActivityHelper(getActivity()).openEmail(); break;
            case 17: //new ActivityHelper(getActivity()).openGoogleInbox(); break;
            case 18: new ActivityHelper(getActivity()).openFeedback(); break;
