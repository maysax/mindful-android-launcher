...
//                notificationSms.setUser_icon(largeIcon);
                ...
                PackageUtil.recreateNotification(notificationSms, context, prefs.tempoType().get(), prefs.tempoSoundProfile().get(), launcherPrefs.isHidenotificationOnLockScreen().get());
