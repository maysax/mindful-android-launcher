        ...
        SchedulingUtils.doOnPreDraw(this, /* drawNextFrame = */ false, new Runnable() {
            ...
            public void run() {
                ...
                if (mIsTwoPanel) {
                    ...
                    getResources().getValue(R.dimen.quickcontact_photo_ratio, photoRatio,
                            /* resolveRefs = */ true);
...
// SKIP       mToolbar.getBoundsOnScreen(largeTextViewRect);
// SKIP       mInvisiblePlaceholderTextView.getBoundsOnScreen(invisiblePlaceholderTextViewRect);
        if (getLayoutDirection() == LAYOUT_DIRECTION_RTL) {
    ...
    private static class AcceleratingFlingInterpolator implements Interpolator {
        ...
        private float getRefreshRate() {
            Display display = ((WindowManager) ContactsApp.getInstance().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
...
// SKIP        mScrollView.suppressLayout(false);
