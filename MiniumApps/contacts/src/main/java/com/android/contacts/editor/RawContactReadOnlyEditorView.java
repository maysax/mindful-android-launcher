    ...
    public void setState(RawContactDelta state, AccountType type, ViewIdGenerator vig,
        ...
        if (isProfile) {
            if (TextUtils.isEmpty(mAccountName)) {
                ...
                mAccountTypeTextView.setText(getContext().getString(R.string.external_profile_title,
                        accountType));
            ...
            mAccountTypeTextView.setText(getContext().getString(R.string.account_type_format,
                    accountType));
        }
        mAccountTypeTextView.setTextColor(getContext().getResources().getColor(
                R.color.secondary_text_color));

        // TODO: Expose data set in the UI somehow?

        mAccountIcon.setImageDrawable(type.getDisplayIcon(getContext()));
        ...
        if (type.getEditContactActivityClassName() != null) {
            ...
            mAccountContainer.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(getContext(), getContext().getString(R.string.contact_read_only),
        ...
        if (phones != null) {
            ...
            for (ValuesDelta phone : phones) {
                ...
                bindData(getContext().getText(R.string.phoneLabelsGroup), formattedNumber,
        ...
        if (emails != null) {
            ...
            for (ValuesDelta email : emails) {
                ...
                bindData(getContext().getText(R.string.emailLabelsGroup), emailAddress, emailType,
                        isFirstEmailBound);
